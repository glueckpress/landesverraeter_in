<?php
/**
 * Plugin Name: _Landesverraeter_in
 ...
 * @return void
 */
function _landesverraeter_in__load_plugin() {

	add_filter( 'template_include', '_landesverraeter_in__show_static_content', 0, 2 );
}
add_action( 'plugins_loaded' , '_landesverraeter_in__load_plugin' );
 ...
 * @return string
 */
function _landesverraeter_in__show_static_content( $template ) {

	$cookie_name   = '_landesverraeter_in';
	$cookie_value  = sanitize_key( time() );
	$cookie_expire = apply_filters( '_landesverraeter_in__cookie_expire', HOUR_IN_SECONDS );
